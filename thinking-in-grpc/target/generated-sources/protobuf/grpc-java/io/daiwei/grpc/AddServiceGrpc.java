...
public final class AddServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.daiwei.grpc.AddRequest,
      io.daiwei.grpc.AddResponse> getAddMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "add",
      requestType = io.daiwei.grpc.AddRequest.class,
      responseType = io.daiwei.grpc.AddResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.daiwei.grpc.AddRequest,
      io.daiwei.grpc.AddResponse> getAddMethod() {
    io.grpc.MethodDescriptor<io.daiwei.grpc.AddRequest, io.daiwei.grpc.AddResponse> getAddMethod;
      ...
      synchronized (AddServiceGrpc.class) {
        if ((getAddMethod = AddServiceGrpc.getAddMethod) == null) {
          AddServiceGrpc.getAddMethod = getAddMethod =
              io.grpc.MethodDescriptor.<io.daiwei.grpc.AddRequest, io.daiwei.grpc.AddResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "add"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.daiwei.grpc.AddRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.daiwei.grpc.AddResponse.getDefaultInstance()))
  ...
  public static abstract class AddServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void add(io.daiwei.grpc.AddRequest request,
        io.grpc.stub.StreamObserver<io.daiwei.grpc.AddResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.daiwei.grpc.AddRequest,
                io.daiwei.grpc.AddResponse>(
                  this, METHODID_ADD)))
          .build();
    }
  }
  ...
  public static final class AddServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AddServiceBlockingStub> {
    ...
    /**
     */
    public io.daiwei.grpc.AddResponse add(io.daiwei.grpc.AddRequest request) {
  ...
  public static final class AddServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AddServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.daiwei.grpc.AddResponse> add(
        io.daiwei.grpc.AddRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD:
          serviceImpl.add((io.daiwei.grpc.AddRequest) request,
              (io.grpc.stub.StreamObserver<io.daiwei.grpc.AddResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AddServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.daiwei.grpc.AddServiceProto.getDescriptor();
    }
